        ...
        <div class="main">
            <div class="center-view">
                ...
                <div class="margin-set system-set">
                    ...
                    <span class="label" v-if="bool"  @click="setting1" >设置</span>
                     <span class="label" v-else @click="setting2" >设置</span>
                    <img
                        src="data:image/png;base64,"
                        alt=""
                        class="arrow"
