                ...
                <div class="hot-city ">
                    ...
                    <ul class="city-index-detail cleanfix">
                        <li class="city-item-detail">
                            <div class="city-item-text" @click="chooseCity(v.name,v.cityId)">北京</div>
                        </li>
                        <li class="city-item-detail">
                            <div class="city-item-text"  @click="chooseCity(v.name,v.cityId)">上海</div>
                        </li>
                        <li class="city-item-detail">
                            <div class="city-item-text"  @click="chooseCity(v.name,v.cityId)">广州</div>
                        </li>
                        <li class="city-item-detail">
                            <div class="city-item-text"  @click="chooseCity(v.name,v.cityId)">深圳</div>
                        </li>
                    </ul>
                </div>
            </div>
